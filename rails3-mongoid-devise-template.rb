...
@recipes = ["jquery", "haml", "rspec", "cucumber", "mongoid", "action_mailer", "devise", "add_user", "home_page", "home_page_users", "seed_database", "users_page", "css_setup", "application_layout", "html5", "devise_navigation", "cleanup", "ban_spiders", "extras", "git"]
...
say_wizard "See http://github.com/RailsApps/rails3-mongoid-devise/issues"
