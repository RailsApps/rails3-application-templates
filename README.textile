...
h4. Template for Rails 3 + Devise + CanCan + Twitter Bootstrap

To build the "rails3-devise-cancan-bootstrap":http://github.com/RailsApps/rails3-devise-cancan-bootstrap/  example application, run the command:

<pre>
$ rails new myapp -m https://raw.github.com/RailsApps/rails3-application-templates/master/rails3-devise-cancan-bootstrap-template.rb -T
</pre>
