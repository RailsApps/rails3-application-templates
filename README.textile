...
|_. File                    |_.                                  |_. Dependencies     |_. Authors |
| "mongoid_cleanup.rb":https://github.com/fortuity/rails3_devise_wizard/blob/master/recipes/mongoid_cleanup.rb        | Installs Mongoid with the bson_ext gem | Mongoid | dkehoe |
...
h4. Recipes for the Rails3-Mongoid-Devise Example App
