...
Use the @-T@ flag to skip Test::Unit files. Add the @-J@ flag for Rails 3.0 (but not for Rails 3.1).
...
Use the @-T -O@ flags to skip Test::Unit files and Active Record files. Add the @-J@ flag for Rails 3.0 (but not for Rails 3.1).
