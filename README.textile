h1. Rails 3.1 Application Templates

These application generator templates give you a Rails 3.1.1 starter app you can deploy in minutes.
...
This creates a new Rails app (with the @myapp@ you provide) on your computer.
...
You must update the standard Ruby installation from Rake 0.8.7 to Rake 0.9.2 (or newer) before using the application templates to generate a new Rails app. See "Installing Rails 3.1":http://railsapps.github.com/installing-rails-3-1.html.
