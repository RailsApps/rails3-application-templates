...
<pre>
The template [https://github.com/RailsApps/rails3-application-templates/raw/master/rails3-devise-rspec-cucumber-template.rb] could not be loaded. Error: You have already activated rake 0.8.7, but your Gemfile requires rake 0.9.0. Consider using bundle exec.
</pre>
