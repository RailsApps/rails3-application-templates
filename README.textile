...
The following recipes were used to create the application template for the rails3-mongoid-devise app.
...
|_. File                    |_.                                  |_. Dependencies     |_. Authors |
| "add_user_name.rb":https://github.com/fortuity/rails3_devise_wizard/blob/master/recipes/add_user_name.rb          | adds name to User, generates Devise views | User model, Devise | dkehoe |
...
| "seed_database.rb":https://github.com/fortuity/rails3_devise_wizard/blob/master/recipes/seed_database.rb          | Adds a db/seeds.rb file with a default user | Mongoid, User model | dkehoe |
