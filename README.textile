...
Use the @-T@ flag to skip Test::Unit files. Add the @-J@ flag for Rails 3.0.
...
Use the @-T -O@ flags to skip Test::Unit files and Active Record files. Add the @-J@ flag for Rails 3.0.
