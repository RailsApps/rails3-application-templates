...
# Usage: rails new APP_NAME -m https://github.com/fortuity/rails3-application-templates/raw/master/rails3-mongoid-omniauth-template.rb -T -O -J

# Information and a tutorial: 
# http://github.com/fortuity/rails3-mongoid-omniauth/
...
@recipes = ["jquery", "haml", "rspec", "cucumber", "mongoid", "seed_database", "add_user", "omniauth", "home_page", "home_page_users", "css_setup", "application_layout", "navigation", "users_page", "omniauth_email", "cleanup", "ban_spiders", "git"] 
...
say_wizard "See http://github.com/fortuity/rails3-mongoid-omniauth/issues"
