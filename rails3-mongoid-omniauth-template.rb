...
@recipes = ["haml", "rspec", "cucumber", "guard", "mongoid", "seed_database", "add_user", "omniauth", "home_page", "home_page_users", "html5", "navigation", "users_page", "omniauth_email", "cleanup", "extras", "git"]
