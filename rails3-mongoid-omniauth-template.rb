...
# Usage: rails new APP_NAME -m https://github.com/RailsApps/rails3-application-templates/raw/master/rails3-mongoid-omniauth-template.rb -T -O -J
...
@recipes = ["rake_fix", "jquery", "haml", "rspec", "cucumber", "mongoid", "seed_database", "add_user", "omniauth", "home_page", "home_page_users", "css_setup", "application_layout", "navigation", "users_page", "omniauth_email", "cleanup", "ban_spiders", "git"]
